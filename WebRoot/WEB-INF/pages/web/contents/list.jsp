...
<body>
	...
	<header id="header" class="header">
			...
			</a><a href="/${moreDatas[0]['description']}" target="_self">${moreDatas[0]["pname"]}</a>  <a href="/web/content/more/${moreDatas[0]['chid']}" target="_self">${moreDatas[0]["cname"]}</a>	
		</div>
	...
	<form action="http://www.c8.cn/fc3dyc" method="post" id="stage_number">
		...
		<section class="news">
			...
			<div class="title">${moreDatas[0]["cname"]}</div>
