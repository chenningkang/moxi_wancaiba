...
<html>
 ...
 <body>
	...
	<div class="box">
		<div class="location">
			<div class="left">
				您现在的位置：<a href="/" target="_self">彩票圈</a> >> <a href="/p3" target="_self">排列三</a>
			</div>
		</div>
	</div>
	<!-- 列表一览 -->
	...
	<div class="box">
		<table border="0" align="center" cellpadding="0" cellspacing="0"
			bordercolor="#5C8FD8" style="border:#5C8FD8 2px solid;margin-top:20px" width="216">
			<thead>
				<tr>
					<td colspan="39" align="center" bgcolor="#B2DBEE"
						style="border-bottom:#5C8FD8 1px solid"  height="32"><strong style="font-size:16px;">排列三开奖历史记录</strong></td>
				</tr>
				<tr bgcolor="#99CCFF">
