 ...
 <body>
	...
	<div class="box">
		<table border="0" align="center" cellpadding="0" cellspacing="0"
			bordercolor="#5C8FD8" style="border:#5C8FD8 2px solid;margin-top:20px" width="890">
			<thead>
				<tr>
					<td colspan="39" align="center" bgcolor="#B2DBEE"
						style="border-bottom:#5C8FD8 1px solid"  height="32"><strong style="font-size:16px;">双色球开奖历史记录走势图</strong></td>
				</tr>
				<tr bgcolor="#99CCFF">
