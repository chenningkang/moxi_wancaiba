	...
	<div class="wrap">
		...
		<div class="c_right">
			...
			<div class="r_position">
				<i></i>
				<p>您当前所在位置：<a href="/admin/index">首页</a> > 个人中心 </p>
			</div>
			<!-- 用户信息list区域 -->
			<div class="r_content">
				<form id="adminUser_form" method="post">
					<div class="con_right">
						<!-- 内容id不为空的时候才显示 -->
						<div class="conr_nr">
							<input type="hidden" class="text kc_name" style="width:100px" name="id" id="p_id" value="${editAdminUser.id}" readonly="readonly" />
							<div class="clearfix"></div>
						</div>
						<!-- 用户名-->
						<div class="conr_nr">
							<div class="choose" style="height:37px;">用户名：</div>
						...
						<!-- 密码 -->
						<div class="conr_nr">
							<div class="choose">新&nbsp;密&nbsp;码：</div>
							<input type="password" class="text kc_name" name="password" style="width:200px"
								id="mxpassword"
						...
						<div class="conr_nr">
							<div class="choose" style="height:37px;">邮&nbsp;箱：</div>
						...
						<div class="conr_nr">
							<div class="choose" style="height:37px;">年&nbsp;龄：</div>
						...
						<div class="conr_nr">
							<div class="choose" style="height:37px;">地&nbsp;址：</div>
						...
						<div class="conr_nr">
							<div class="choose" style="height:37px;">性&nbsp;别：</div>
							<label class="labelstyle">
								<input type="radio"  class="malestyle" name="male" ${editAdminUser.male=='1'?'checked':''} value="1">男
							</label>
							<label class="labelstyle">
