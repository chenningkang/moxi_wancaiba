...
<head>
    ...
    <title>忘记密码-万彩吧_pk10北京赛车_时时彩_快3_11选5_天下彩_天空彩票_快乐10分</title>
        ...
        <div class="login-page">
            ...
            <div class="para reg-plan-div hide">
                ...
                <div class="reg-plan-text">
                    ...
                    <span class="spt1 active">设置密码</span>
                    <span class="spt2">成功</span>
                </div>
            </div>
            ...
            <div class="login-wrap">
                <div class="tel-wrap">
                    ...
                    <div class="line dntop">
                        ...
                        <div class="yma"><img src="/verify?random=1860" ></div>
                    </div>
                    <input hidden id="mark" type="text" value="/fm/fone">

                    <div id="register-btn" class="login-btn tc">获取验证码</div>
                </div>

                <div class="password-wrap" style="display:none">
                    <form id="register-form" method="post" action="/fm/ftwo">
                        ...
                        <div class="line  dnbottom">
                            <p class="o-lt">新密码</p>
                            <p class="o-lt3"><input name="pwd1" class="box" type="password" placeholder="6-20个数字和字母"></p>
                        </div>
                        <div class="reg-sheet-line"></div>
                        <div class="line dntop ">
                            <p class="o-lt">确认密码</p>
                        ...
                        <div id="register-submit" class="login-btn tc">提交</div>
                    </form>
                </div>
            </div>
        </div>
